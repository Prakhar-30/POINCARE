...
| Item | Status |
|---|---|
| External human security audit | **Required before mainnet.** An automated Olympix pre-audit scan was run and every finding fixed (`SECURITY.md`), which is not a substitute. |
