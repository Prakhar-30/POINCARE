...
///              CUSUM (the A1 guard).
///           3. (v2, README §9.2) σ-inflation against the ADAPTIVE detector: whipsawing the pool
...
contract ManipulationTest is PoincareTestBase {
    ...
    /// @notice The v2 second-order channel (README §9.2): inflate σ̂ with a whipsaw so the
