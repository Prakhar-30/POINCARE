...
protect), **grows through the trends**, and **jumps during the flash-crash + whipsaw** — Poincaré
...
June leg-down** — the detector engaged on the two real sustained downtrends and stayed neutral in
...
so v2 needs its **own manipulation-cost bound** re-derived — the same robust/minimax-QCD discipline
